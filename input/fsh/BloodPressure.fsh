...
* ^version = "0.1.0"
* ^abstract = false
* ^type = "http://bloodpressure.oemig.de/fhir/StructureDefinition/BloodPressure"
...
* meanArterialPressure 0..1 BackboneElement "mean arterial blood pressure" "The average arterial pressure that occurs over the entire course of the heart contraction and relaxation cycle."
  * code 0..1 CodeableConcept "code, in case of a precoordinated concept"
  * code from http://bloodpressure.oemig.de/fhir/ValueSet/us-core-mean-arterial-blood-pressure-code (extensible)
  * value 1..1 positiveInt "value"
    * obeys shall-be-under-1000-mmHg
  * unit 1..1 CodeableConcept "units"
  * unit from http://bloodpressure.oemig.de/fhir/ValueSet/BPunits (required)
...
* pulsePressure 0..1 BackboneElement "pulse blood pressure" "The difference between the systolic and diastolic pressure."
  * code 0..1 CodeableConcept "code, in case of a precoordinated concept"
  * code from http://bloodpressure.oemig.de/fhir/ValueSet/us-core-pulse-blood-pressure-code (extensible)
  * value 1..1 positiveInt "value"
    * obeys shall-be-under-1000-mmHg
  * unit 1..1 CodeableConcept "units"
  * unit from http://bloodpressure.oemig.de/fhir/ValueSet/BPunits (required)
...
* location from http://bloodpressure.oemig.de/fhir/ValueSet/Location (required)
...
* ^url = "http://bloodpressure.oemig.de/fhir/ValueSet/CuffType"
* ^version = "0.1.0"

* insert HeaderDetailRules

* include codes from system http://bloodpressure.oemig.de/fhir/CodeSystem/CuffType
...
* ^url = "http://bloodpressure.oemig.de/fhir/ValueSet/CuffSize"
* ^version = "0.1.0"

* insert HeaderDetailRules

* include codes from system http://bloodpressure.oemig.de/fhir/CodeSystem/CuffSize
...
* ^caseSensitive = false
* ^valueSet = "http://bloodpressure.oemig.de/fhir/ValueSet/Consciousness"
* ^hierarchyMeaning = #is-a
* ^compositional = false
* ^versionNeeded = false
* ^content = #complete
...
* ^url = "http://bloodpressure.oemig.de/fhir/ValueSet/Consciousness"
* ^version = "0.1.0"

* insert HeaderDetailRules

* include codes from system http://bloodpressure.oemig.de/fhir/CodeSystem/Consciousness
...
* ^url = "http://bloodpressure.oemig.de/fhir/ValueSet/Anaesthesia"
* ^version = "0.1.0"

* insert HeaderDetailRules

* include codes from system http://bloodpressure.oemig.de/fhir/CodeSystem/Anaesthesia
...
* ^caseSensitive = false
* ^valueSet = "http://bloodpressure.oemig.de/fhir/ValueSet/Position"
* ^hierarchyMeaning = #is-a
* ^compositional = false
* ^versionNeeded = false
* ^content = #complete
...
* ^url = "http://bloodpressure.oemig.de/fhir/ValueSet/Position"
* ^version = "0.1.0"
...
* ^url = "http://bloodpressure.oemig.de/fhir/ValueSet/BodyPosition"
* ^version = "0.1.0"
...
* ^compose.include[+].system = "http://bloodpressure.oemig.de/fhir/CodeSystem/Position"
...
* ^url = "http://bloodpressure.oemig.de/fhir/ValueSet/Location"
* ^version = "0.1.0"

* insert HeaderDetailRules

* include codes from system http://bloodpressure.oemig.de/fhir/CodeSystem/Location
...
* ^url = "http://bloodpressure.oemig.de/fhir/CodeSystem/Exertion"
* ^version = "0.1.0"

* insert HeaderDetailRules

* ^caseSensitive = false
* ^valueSet = "http://bloodpressure.oemig.de/fhir/ValueSet/Exertion"
* ^hierarchyMeaning = #is-a
* ^compositional = false
* ^versionNeeded = false
* ^content = #complete
...
* ^url = "http://bloodpressure.oemig.de/fhir/ValueSet/Exertion"
* ^version = "0.1.0"

* insert HeaderDetailRules

* include codes from system http://bloodpressure.oemig.de/fhir/CodeSystem/Exertion
