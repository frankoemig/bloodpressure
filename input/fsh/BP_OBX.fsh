...
* ^version = "0.1.0"
* ^abstract = false
* ^type = "http://bloodpressure.oemig.de/fhir/StructureDefinition/AbstractSegment"
...
* valueDataType MS
* observationCode MS
* observationCode = http://bloodpressure.oemig.de/fhir/CodeSystem/ObservationCodes#meanArterial
* value MS
...
* valueDataType MS
* observationCode MS
* observationCode = http://bloodpressure.oemig.de/fhir/CodeSystem/ObservationCodes#exertion
* value MS
