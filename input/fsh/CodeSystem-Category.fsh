...
* ^url = "http://bloodpressure.oemig.de/fhir/ValueSet/ObservationCategory"
* ^version = "0.1.0"

* insert HeaderDetailRules

* include codes from system http://bloodpressure.oemig.de/fhir/CodeSystem/ObservationCategory
...
* ^url = "http://bloodpressure.oemig.de/fhir/ValueSet/ObservationVitalSignsCategory"
* ^version = "0.1.0"

* insert HeaderDetailRules

//* include codes from system http://bloodpressure.oemig.de/fhir/CodeSystem/ObservationCategory where code descendent-of #vital-sign
...
* ^url = "http://bloodpressure.oemig.de/fhir/ValueSet/ObservationVitalSignsBPCategory"
* ^version = "0.1.0"

* insert HeaderDetailRules

//* include codes from system http://bloodpressure.oemig.de/fhir/CodeSystem/ObservationCategory where code descendent-of #vital-sign-bp
